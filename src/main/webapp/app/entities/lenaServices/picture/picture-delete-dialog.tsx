  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="lenaGatewayApp.lenaServicesPicture.delete.question">
          <Translate contentKey="lenaGatewayApp.lenaServicesPicture.delete.question" interpolate={{ id: pictureEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-picture" color="danger" onClick={this.confirmDelete}>
